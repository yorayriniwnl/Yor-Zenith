    ...
    <section className="rounded-[2rem] border border-[#13322b] bg-[#07110f] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)]">
      <div className="mb-5 flex items-center justify-between gap-3">
        ...
        <div className="rounded-full border border-emerald-400/20 bg-emerald-400/10 px-3 py-1.5 text-xs font-medium text-emerald-300">
          Simulated tick {secondsAgo.toFixed(1)}s
        </div>
      </div>
        ...
        <main className="relative z-10 mx-auto w-full max-w-[92rem] space-y-7 px-6 py-10 lg:px-10 xl:px-14">
            ...
            <div className="flex flex-col gap-8 xl:flex-row xl:items-end xl:justify-between">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] px-5 py-3.5 text-sm text-[#9fb0bb]">
                  Simulation state updates after each dispatch cycle; no grid commands are sent
                </div>
              </div>
            </div>
          </section>
          ...
          {showingDemo && (
            <div className="rounded-2xl border border-amber-400/20 bg-amber-400/[0.08] px-4 py-3 text-sm text-amber-100">
              Illustrative preset loaded. These values are simulated planning data, not live grid telemetry or control signals.
            </div>
          )}
          ...
          <section className="grid gap-6 xl:grid-cols-[minmax(19rem,0.9fr)_minmax(0,1.25fr)]">
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="rounded-2xl border border-white/6 bg-[#0b1715] px-4 py-4 text-sm text-[#8ea5b4]">
                    {result
                      ? "Scenario completed. Inspect the graph and routing panel for simulated neighborhood movement."
            ...
            <div className="space-y-6">
              <PanelShell
                ...
                title="Simulated Microgrid View"
                ...
                actions={
                  <div className="rounded-full border border-cyan-400/[0.15] bg-cyan-500/10 px-4 py-2 text-xs font-medium uppercase tracking-[0.18em] text-cyan-300">
                    {isBusy ? "Simulating" : "Scenario View"}
                  </div>
                }
              >
          ...
          <section className="grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_minmax(20rem,0.85fr)]">
            ...
            <PanelShell
              ...
              description="A compact view of how the model balances shared energy, grid draw, and savings for this scenario."
            >
              <div className="space-y-6">
