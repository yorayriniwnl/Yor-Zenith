/*
 * Legacy visualization engine: this file is intentionally isolated from the
 * React Compiler lint rules while it is decomposed. It mutates Three.js scene
 * objects inside frame loops and shader callbacks, which is required by the
 * renderer but conflicts with React's static purity rules. Keep the production
 * build and runtime smoke tests as the release gates for this module.
 */
/* eslint-disable react-hooks/exhaustive-deps, react-hooks/immutability, react-hooks/preserve-manual-memoization, react-hooks/purity, react-hooks/refs, react-hooks/set-state-in-effect */
