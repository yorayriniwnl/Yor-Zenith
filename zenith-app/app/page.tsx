      ...
      <div className="space-y-24 max-w-[84rem] mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <h3 className="text-3xl md:text-4xl font-black mb-3 uppercase">
              5. Lumen Logic
            </h3>

            <p className="text-zinc-500 text-sm font-semibold uppercase tracking-widest mb-6">
              Real-time Microgrid Optimizer
            </p>

            <p className="text-zinc-400 text-lg leading-relaxed mb-8">
              Lumen Logic brings real-time intelligence to every watt flowing through a home microgrid.
              By continuously monitoring generation, consumption, and grid signals, the system dynamically
              balances solar output, battery storage, and grid draw to maximize self-sufficiency and minimize
              cost. The AI layer translates live energy flows into plain-language actions — automatically
              shifting loads, flagging inefficiencies, and adapting to tariff windows before the next billing
              cycle even begins. It's not just monitoring; it's an always-on optimizer working in the background.
            </p>

            <button
              onClick={() => navigateProtected("/lumen")}
              className="px-8 py-4 bg-emerald-500 text-black font-bold uppercase tracking-widest rounded-xl hover:bg-emerald-400 hover:text-black transition-all duration-200"
            >
              Optimize Grid
            </button>
